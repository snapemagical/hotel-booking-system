...
// The hotel-booking module (Phase 2) will use room/booking/guest/payment keys;
// this map is ready for them ahead of time.
const ICONS = {
  room: BedDouble,
